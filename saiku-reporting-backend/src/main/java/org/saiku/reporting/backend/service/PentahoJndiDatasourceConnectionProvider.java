...
//						throw new SQLException("PentahoDatasourceConnectionProvider.ERROR_0001_INVALID_CONNECTION"); //$NON-NLS-1$
//					}
//					return connection;
//				}
//
...
//			    final IDatasourceService datasourceService = PentahoSystem.getObjectFactory().get(IDatasourceService.class, null);
//				datasourceService.clearDataSource(jndiName);
//				throw new SQLException("PentahoDatasourceConnectionProvider.ERROR_0002_UNABLE_TO_FACTORY_OBJECT"); //$NON-NLS-1$
//			}
